            ...
            <div className="pt-5">
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-2.5">
                <button
                  ...
                  className="bg-gray-100 text-xs font-semibold rounded-xl py-1.5 px-3 cursor-pointer hover:bg-hover-text-green hover:text-indigo-500"
                  type="button"
                ...
                <button
                  ...
                  className="bg-gray-100 text-xs font-semibold rounded-xl p-1.5 px-3 cursor-pointer hover:bg-hover-text-green hover:text-indigo-500"
                  type="button"
                  onClick={handleRecButton}
                >
                  stroke recovery
