...
export default function SavedTechniques() {
    ...
    return (
        <section className="bg-gray-50 min-h-screen">
            <div className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-center text-white  px-4 sm:px-6 lg:px-8">
                ...
                <p className="mt-4 text-xl text-indigo-100">Track your progress and revisit techniques that have helped you</p>
            </div>
            ...
            <div className="my-20 max-w-7xl mx-auto rounded px-4 sm:px-6 lg:px-8">
                <div className="p-12 flex flex-col items-center bg-white shadow-xl">
                    ...
                    <p className="mt-5 max-w-md text-center text-gray-600">When you find techniques that might help, save them here to track your progress with what works.</p>
                    <Link href="/explorer" className="mt-5 p-4 bg-indigo-600 rounded-lg text-white text-md font-semibold">
                    Explore Techniques
                    </Link>
                </div>
            </div>
