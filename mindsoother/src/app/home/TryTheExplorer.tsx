    ...
    <section className="bg-indigo-900 text-white py-12">
      <div className="mx-auto max-w-7xl lg:px-8 sm:px-6 px-4">
        ...
        <div className="flex pt-10">
          <a href="/explorer" className="flex inline-flex mx-auto items-center bg-white hover:bg-indigo-50 py-4 px-6 text-indigo-900 font-bold rounded-xl cursor-pointer">
            Try the Explorer
            <IoArrowForwardSharp
