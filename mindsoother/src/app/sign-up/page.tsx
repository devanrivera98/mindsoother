      ...
      <div className="w-full sm:max-w-lg flex flex-col mx-auto">
        <div className="border rounded border-gray-100 shadow-lg mt-10 px-10">
            <form className="py-10  flex flex-col gap-y-4">
                <FormInput Icon={IoPersonOutline} name={"Full Name"} placeholder={"Enter your full name"} autoComplete="name" />
                <FormInput Icon={IoMailOutline} name={"Email Address"} placeholder={"Enter email here"} autoComplete="email" />
                <PasswordInput Icon={IoLockClosedOutline} name={"Password"} placeholder={"Create your password"} />
                <PasswordInput Icon={IoLockClosedOutline} name={"Confirm Password"} placeholder={"Confirm your password"} />
